...
namespace KetBot.Data.Services
{
    ...
    {
        static AzureAuthToken defaultInstance = new AzureAuthToken(ConfigurationManager.AppSettings["TranlatorApiKey"]);
        ...
        private AzureAuthToken(string key)
        {
        ...
        public static AzureAuthToken DefaultInstance
        {
            get
            {
